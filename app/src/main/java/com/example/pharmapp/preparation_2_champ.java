...
public class preparation_2_champ extends AppCompatActivity {

    EditText resultat_bilan_input, resultat_bilan_input2;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.preparation_2_champ);
    ...
    public void calculer_dose_adm(View view) {
        ...
        if (res_1.isEmpty() || res_2.isEmpty()) {
            if (res_1.isEmpty()) {
            ...
            int id_med = -1;
            double coeff_min = -1, dose_complet = -1, dose_adm = -1, coeff_min_1 = -1, coeff_min_2 = -1;

            DataBase myDB = new DataBase(preparation_2_champ.this);
            ...
            coeff_min = trouve_min(coeff_min_1, coeff_min_2);
    ...
    double trouve_min(double a, double b)
    {
        if(a <= b)
            return a;
        else {
